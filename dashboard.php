...
// Only fetch stats for staff roles
if (userHasAnyRole([ROLE_ADMIN, ROLE_DOCTOR, ROLE_NURSE, ROLE_PHARMACY])) {
    ...
    // Initialize counts to 0 for patients
    $todaysCount = 0;
    $currentWeekCount = 0;
    $currentMonthCount = 0;
    $currentYearCount = 0;
...
<head>
 ...
 <title>Application of Mobile Cloud Computing in Healthcare Pathways</title>
<style>
...
?>  
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        <?php if (userHasAnyRole([ROLE_ADMIN, ROLE_DOCTOR, ROLE_NURSE, ROLE_PHARMACY])): ?>
            <!-- Staff Dashboard -->
            <div class="row">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p>View your medical records and upcoming appointments using the menu.</p>
                            <a href="my_records.php" class="btn btn-primary">View My Records</a>
                        </div>
                    </div>
                </div>
            </div>
