...
$updateUserQuery = "UPDATE `users` SET `display_name` = :display_name, `user_name` = :user_name";
$params = [
...
if ($status) {
    $updateUserQuery .= ", `profile_picture` = :profile_picture";
    $params[':profile_picture'] = $targetFile;
}
