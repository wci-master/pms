...
try {
  ...
  $stmtPatient->bindParam(':patient_name', $patientName);
  $stmtPatient->bindParam(':address', $address);
  $stmtPatient->bindParam(':cnic', $cnic);
  $stmtPatient->bindParam(':date_of_birth', $dateBirth);
  $stmtPatient->bindParam(':phone_number', $phoneNumber);
  $stmtPatient->bindParam(':gender', $gender);
  $stmtPatient->bindParam(':id', $hiddenId);
  $stmtPatient->execute();
