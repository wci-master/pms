...
if(isset($_POST['submit'])) {
  ...
  try {
    ...
    $stmtUpdate->bindParam(':medicine_id', $medicineId);
    $stmtUpdate->bindParam(':packing', $packing);
    $stmtUpdate->bindParam(':medicine_detail_id', $medicineDetailId);
    $stmtUpdate->execute();
